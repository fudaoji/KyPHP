...
CREATE TABLE `ky_addons` (
  ...
  `type` varchar(100) NOT NULL DEFAULT 'mp' COMMENT '支持平台',
...
CREATE TABLE `ky_addons_cate` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='应用分类表';

-- ----------------------------
-- Records of ky_addons_cate
-- ----------------------------
INSERT INTO `ky_addons_cate` VALUES ('1', '涨粉', '2', '1594997635', '1604326895', '1');
INSERT INTO `ky_addons_cate` VALUES ('2', '营销', '3', '1594997967', '1604326895', '1');
INSERT INTO `ky_addons_cate` VALUES ('3', '商城', '0', '1594997977', '1604326893', '1');
INSERT INTO `ky_addons_cate` VALUES ('4', '游戏', '10', '1594997996', '1604326896', '1');
INSERT INTO `ky_addons_cate` VALUES ('5', '节日', '5', '1594998006', '1604326896', '1');
INSERT INTO `ky_addons_cate` VALUES ('6', '共享', '0', '1597459141', '1604326894', '1');
INSERT INTO `ky_addons_cate` VALUES ('7', '工具', '0', '1604326937', '1604326937', '1');
...
CREATE TABLE `ky_addons_info` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '应用ID（即addons中的id）',
  ...
  `snapshot` text COMMENT ' 应用快照',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='应用详细信息';
...
CREATE TABLE `ky_addons_template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `addon` (`addon`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序应用对应的模板id';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='系统会员表';

-- ----------------------------
-- Records of ky_admin
-- ----------------------------
INSERT INTO `ky_admin` VALUES ('1', 'admin', '$2y$10$lSnmo7isc6Y7X1trZ/YeH.WirmUAC3TG8JpEkloRODCO1nHXYFnFm', '461960962@qq.com', '15659827559', '0', '1630909647', '1', '1', '傅道集', '1630909647', '106.122.207.144', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='客户-应用关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='会员权限组';

-- ----------------------------
-- Records of ky_admin_group
-- ----------------------------
INSERT INTO `ky_admin_group` VALUES ('1', '管理员', '{\"mp_limit\":\"0\",\"mini_limit\":\"0\"}', '111,108,114,129,132,134,115,131,109,112,1,13,14,15,47,17,18,16,68,19,20,43,96,61,64,46,62,63,80,21,22,72,52,84,2,45,56,74,73,67,53,69,81,57,25,83,26,51', '1', '0', '1594302168', '1626769296');
INSERT INTO `ky_admin_group` VALUES ('2', '游客', '{\"mp_limit\":\"2\",\"mini_limit\":\"2\"}', '111,108,114,129,132,134,115,131,109,112,1,13,14,15,47,17,18,16,68,19,20,43,96,61,64,46,62,63,80,21,22,102,72,93,94,100,101,52,84', '1', '0', '1594303678', '1626769106');
...
-- ----------------------------
-- Table structure for ky_admin_setting
-- ----------------------------
DROP TABLE IF EXISTS `ky_admin_setting`;
CREATE TABLE `ky_admin_setting` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'admin  id',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='站点配置';
...
CREATE TABLE `ky_admin_store` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='会员店铺';
...
CREATE TABLE `ky_district` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='省市地区字典';
...
CREATE TABLE `ky_friend_link` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='友链';
...
CREATE TABLE `ky_media_image_1` (
  ...
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '平台（admin_store）ID',
...
CREATE TABLE `ky_media_music_1` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='音乐素材';
...
CREATE TABLE `ky_media_music_2` (
  ...
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='音乐素材';
...
-- ----------------------------
-- Table structure for ky_media_news_1
-- ----------------------------
DROP TABLE IF EXISTS `ky_media_news_1`;
CREATE TABLE `ky_media_news_1` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号id',
  `title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文标题',
  `thumb_media_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '封面图片 mediaId',
  `cover_url` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '封面图url',
  `author` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '作者',
  `show_cover_pic` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否在文章内容显示封面图片（1：是；0：否）',
  `digest` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文章内容摘要',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '正文内容',
  `content_source_url` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文消息的原文地址',
  `media_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文消息的id',
  `url` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文链接，获取素材中得到的',
  `index` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '要更新的文章在图文消息中的位置（多图文消息时，此字段才有意义），第一篇为0',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '头条id',
  `type` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '图文类型（1：微信图文；2：消息链接）',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`,`mpid`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='图文表';

-- ----------------------------
-- Records of ky_media_news_1
-- ----------------------------

-- ----------------------------
-- Table structure for ky_media_news_2
-- ----------------------------
DROP TABLE IF EXISTS `ky_media_news_2`;
CREATE TABLE `ky_media_news_2` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号id',
  `title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文标题',
  ...
  KEY `uid` (`uid`,`mpid`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='图文表';

-- ----------------------------
-- Records of ky_media_news_2
-- ----------------------------

-- ----------------------------
-- Table structure for ky_media_news_3
-- ----------------------------
DROP TABLE IF EXISTS `ky_media_news_3`;
CREATE TABLE `ky_media_news_3` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号id',
  `title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文标题',
...
-- ----------------------------
-- Records of ky_media_news_3
-- ----------------------------

-- ----------------------------
-- Table structure for ky_media_news_4
-- ----------------------------
DROP TABLE IF EXISTS `ky_media_news_4`;
CREATE TABLE `ky_media_news_4` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号id',
  `title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文标题',
...
-- ----------------------------
-- Records of ky_media_news_4
-- ----------------------------

-- ----------------------------
-- Table structure for ky_media_news_5
-- ----------------------------
DROP TABLE IF EXISTS `ky_media_news_5`;
CREATE TABLE `ky_media_news_5` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `mpid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号id',
  `title` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图文标题',
...
CREATE TABLE `ky_media_video_1` (
  ...
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='视频素材';
...
CREATE TABLE `ky_media_video_2` (
  ...
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='视频素材';
...
CREATE TABLE `ky_media_voice_1` (
  ...
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='语音素材';
...
CREATE TABLE `ky_media_voice_2` (
  ...
  KEY `id_uid` (`id`,`uid`),
  KEY `id_uid_mpid` (`id`,`uid`,`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='语音素材';
...
CREATE TABLE `ky_menu` (
  ...
  `pid` int(5) unsigned NOT NULL COMMENT '上级ID',
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=139 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统菜单';

-- ----------------------------
-- Records of ky_menu
-- ----------------------------
INSERT INTO `ky_menu` VALUES ('1', '0', '微信公众号', 'mp/index/index', '1', '&#xe63a;', '', '1', '0', '1626799577', '1');
INSERT INTO `ky_menu` VALUES ('2', '0', '站点', 'system/admin/index', '10', '&#xe620;', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('13', '1', '增强功能', 'null', '0', 'fa fa-briefcase', '', '1', '0', '1626798775', '1');
INSERT INTO `ky_menu` VALUES ('14', '13', '自动回复', 'mp/reply/index', '0', '', '', '1', '0', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('15', '13', '自定义菜单', 'mp/menu/index', '1', '', '', '1', '0', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('16', '13', '功能配置', 'mp/setting/index', '10', '', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('17', '13', '二维码/转化链接 ', 'mp/qrcode/index', '4', '', '', '1', '0', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('18', '13', '素材管理', 'mp/material/index', '5', '', '', '1', '0', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('19', '1', '粉丝', 'null', '2', 'fa fa-users', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('20', '19', '粉丝管理', 'mp/follow/index', '0', '', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('21', '94', '微信', '', '0', 'fa fa-wechat', '', '1', '0', '1626799223', '1');
INSERT INTO `ky_menu` VALUES ('22', '21', '公众号', 'system/mp/index', '1', 'fa fa-wechat', '', '1', '0', '1626799260', '1');
INSERT INTO `ky_menu` VALUES ('23', '22', '手动接入', 'system/mp/add', '3', '', '', '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('25', '2', '设置', '', '20', 'fa fa-cogs', '', '1', '0', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('26', '25', '菜单设置', 'admin/menu/index', '1', '', '', '1', '0', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('27', '26', '增加菜单', 'admin/menu/add', '2', '', '', '1', '0', '1604285292', '2');
INSERT INTO `ky_menu` VALUES ('28', '22', '编辑公众号', 'system/mp/edit', '5', '', '', '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('29', '22', '管理设置', 'system/mp/info', '3', '', '', '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('30', '17', '增加二维码', 'mp/qrcode/add', '0', '', '', '1', '0', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('32', '14', '增加关键词', 'mp/reply/add', '0', '', '', '1', '0', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('41', '14', '特殊消息', 'mp/reply/special', '0', '', '', '1', '0', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('43', '0', '应用', 'system/store/myapps', '4', '&#xe635;', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('45', '2', '应用管理', 'null', '1', 'fa fa-cubes', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('46', '61', '已过期', 'system/store/overtime', '3', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('47', '13', '消息管理', 'mp/msg/index', '1', '', null, '1', '0', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('48', '47', '回复消息', 'mp/msg/detail', '0', '', null, '1', '0', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('50', '26', '修改菜单', 'admin/menu/edit', '0', '', null, '1', '0', '1604285292', '2');
INSERT INTO `ky_menu` VALUES ('51', '25', '微信开放平台', 'system/mp/platform', '3', '', null, '1', '0', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('52', '80', '用户/权限', '', '5', 'fa fa-users', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('53', '67', '注册会员', 'system/admin/index', '0', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('54', '53', '更改密码', 'system/admin/updatepwd', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('55', '53', '增加成员', 'system/admin/add', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('56', '45', '应用管理', 'admin/app/index', '0', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('57', '81', '系统公告', 'admin/notice/index', '1', '', null, '1', '0', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('58', '60', '编辑应用分类', 'admin/addoncate/edit', '3', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('59', '60', '新增应用分类', 'admin/addoncate/add', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('60', '45', '应用分类', 'admin/addoncate/index', '5', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('61', '43', '我的应用', '', '1', 'fa fa-cubes', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('62', '43', '应用市场', '', '4', 'fa fa-cubes', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('63', '62', '应用采购', 'system/store/apps', '0', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('64', '61', '正常应用', 'system/store/myapps', '0', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('65', '22', '选择接入方式', 'system/mp/choose', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('66', '69', '编辑用户组', 'admin/admingroup/edit', '2', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('67', '2', '用户管理', 'NULL', '5', 'fa fa-bars', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('68', '1', '数据统计', 'mp/index/index', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('69', '67', '用户组', 'admin/admingroup/index', '3', '&#xe68b;', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('70', '69', '新增用户组', 'admin/admingroup/add', '1', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('71', '17', '二维码统计', 'mp/qrcode/log', '2', '', null, '1', '0', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('72', '80', '欢迎回来', 'system/index/index', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('73', '74', '应用商店', 'admin/appstore/index', '2', '', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('74', '2', '官方市场', 'NULL', '2', 'fa fa-cart-plus', null, '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('75', '73', '官方市场注册', 'admin/appstore/register', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('76', '73', '官方市场登录', 'admin/appstore/login', '0', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('77', '56', '编辑应用信息', 'admin/app/edit', '3', '', null, '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('80', '0', '系统', 'system/index/index', '5', '', '', '1', '0', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('81', '2', '消息管理', '', '15', 'fa fa-bullhorn', '', '1', '0', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('82', '53', '编辑信息', 'system/admin/edit', '3', '', '', '1', '0', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('83', '25', '站点设置', 'admin/setting/index', '0', '', '', '1', '1590246581', '1604285292', '1');
INSERT INTO `ky_menu` VALUES ('84', '52', '我的账号', 'system/admin/myinfo', '0', '', '', '1', '1590410830', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('85', '84', '重置密码', 'system/admin/updatemypwd', '1', '', '', '1', '1590411654', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('86', '57', '发布公告', 'admin/notice/add', '1', 'fa fa-plus', '', '1', '1590593322', '1604285292', '2');
INSERT INTO `ky_menu` VALUES ('87', '22', '授权接入', 'mp/auth/index', '5', '', '', '1', '1590654308', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('88', '14', ' 编辑关键词', 'mp/reply/edit', '1', '', '', '1', '1591021404', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('89', '67', '用户应用', 'admin/adminaddon/index', '5', '', '', '1', '1594806392', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('90', '89', '开通应用', 'admin/adminaddon/add', '0', '', '', '1', '1594812008', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('91', '89', '编辑用户应用', 'admin/adminaddon/edit', '2', '', '', '1', '1594812032', '1604285292', '2');
INSERT INTO `ky_menu` VALUES ('92', '57', '编辑公告', 'admin/notice/edit', '5', '', '', '1', '1594896676', '1604285292', '2');
INSERT INTO `ky_menu` VALUES ('93', '80', '系统通知', 'system/notice/index', '0', '', '', '1', '1594900050', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('94', '0', '平台', 'system/store/index', '0', '', '', '1', '1594970326', '1626796973', '1');
INSERT INTO `ky_menu` VALUES ('95', '63', '应用下单', 'system/store/appdetail', '0', '', '', '1', '1595247406', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('96', '43', '订单支付', 'system/payment/orderaddon', '0', '', '', '1', '1595307609', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('97', '2', '财务管理', '', '0', 'fa fa-money', '', '1', '1595314612', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('98', '97', '应用订单', 'admin/orderaddon/index', '0', '', '', '1', '1595314675', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('99', '98', '修改订单', 'admin/orderaddon/edit', '0', '', '', '1', '1595324991', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('100', '80', '财务管理', '', '0', 'fa fa-money', '', '1', '1595327151', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('101', '100', '应用订单', 'system/orderaddon/index', '0', '', '', '1', '1595327214', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('102', '21', '小程序', 'system/mini/index', '3', 'fa fa-weixin', '', '1', '1595416032', '1626799550', '1');
INSERT INTO `ky_menu` VALUES ('103', '102', '添加小程序', 'system/mini/choose', '0', '', '', '1', '1595471638', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('104', '102', '手动添加小程序', 'system/mini/add', '0', '', '', '1', '1595471732', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('105', '102', '管理设置', 'system/mini/info', '0', '', '', '1', '1595485512', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('106', '102', '编辑小程序', 'system/mini/edit', '0', '', '', '1', '1595485527', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('107', '102', '授权失败', 'mini/auth/fail', '0', '', '', '1', '1595494584', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('108', '111', '管理', '', '0', 'fa fa-th-list', '', '1', '1595561919', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('109', '115', '用户管理', 'mini/follow/index', '3', '', '', '1', '1595562103', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('111', '0', '微信小程序', 'mini/index/index', '0', '', '', '1', '1595563196', '1626799560', '1');
INSERT INTO `ky_menu` VALUES ('112', '115', '配置', 'mini/setting/index', '10', '', '', '1', '1595571661', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('113', '45', '小程序模板', 'admin/minitemplate/index', '10', '', '', '1', '1595578963', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('114', '108', '版本管理', 'mini/template/index', '0', '', '', '1', '1595660483', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('115', '111', '功能', '', '3', 'fa fa-list', '', '1', '1595660750', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('116', '56', '设置模版', 'admin/app/settemplate', '0', '', '', '1', '1595681557', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('117', '114', '新建版本', 'mini/template/choose', '0', '', '', '1', '1595772252', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('118', '114', '历史版本', 'mini/template/log', '0', '', '', '1', '1595843089', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('120', '119', '新增体验者', 'mini/tester/add', '0', '', '', '1', '1595902322', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('121', '115', '小程序码', 'mini/qrcode/index', '7', '', '', '0', '1595935890', '1604285290', '1');
INSERT INTO `ky_menu` VALUES ('122', '2', '运营管理', '', '0', 'fa fa-bar-chart', '', '1', '1596271318', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('123', '122', '友情链接', 'admin/friendlink/index', '0', '', '', '1', '1596271404', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('124', '123', '新增友链', 'admin/friendlink/add', '0', '', '', '1', '1596273508', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('125', '123', '编辑友链', 'admin/friendlink/edit', '0', '', '', '1', '1596273522', '1604285291', '2');
INSERT INTO `ky_menu` VALUES ('127', '74', '应用升级', 'admin/appstore/upgrade', '3', '', '', '1', '1599096597', '1604285291', '1');
INSERT INTO `ky_menu` VALUES ('128', '18', '新增图文', 'mp/material/newsadd', '0', '', '', '1', '1603893364', '1604285290', '2');
INSERT INTO `ky_menu` VALUES ('129', '108', '体验者管理', 'mini/tester/index', '3', '', '', '1', '1604972179', '1604972179', '1');
INSERT INTO `ky_menu` VALUES ('130', '129', '新增体验者', 'mini/tester/add', '0', '', '', '1', '1604972197', '1627568142', '2');
INSERT INTO `ky_menu` VALUES ('131', '115', '数据统计与分析', 'mini/index/index', '0', '', '', '1', '1604972245', '1604972245', '1');
INSERT INTO `ky_menu` VALUES ('132', '108', '类目管理', 'mini/category/index', '5', '', '', '1', '1605521429', '1605521429', '1');
INSERT INTO `ky_menu` VALUES ('133', '132', '新增类目', 'mini/category/add', '0', '', '', '1', '1605521452', '1605521452', '2');
INSERT INTO `ky_menu` VALUES ('134', '108', '扫码关注组件', 'mini/showwxa/index', '7', '', '', '1', '1605584417', '1605584417', '1');
INSERT INTO `ky_menu` VALUES ('136', '80', '系统管理', '', '10', 'fa fa-cogs', '', '1', '1627656978', '1627657021', '1');
INSERT INTO `ky_menu` VALUES ('137', '136', '设置', 'system/setting/index', '0', '', '', '1', '1627657009', '1627657009', '1');
INSERT INTO `ky_menu` VALUES ('138', '56', '配置', 'admin/app/config', '0', '', '', '1', '1630724653', '1630724653', '2');
...
CREATE TABLE `ky_mini` (
  `id` int(10) unsigned NOT NULL COMMENT 'store中的id',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  KEY `uid` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序平台';
...
CREATE TABLE `ky_mini_addon` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `mpid_addon` (`mini_id`,`addon`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='小程序-插件关联表';
...
CREATE TABLE `ky_mini_follow_1` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `openid` (`mini_id`,`openid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序微信用户表';
...
CREATE TABLE `ky_mini_follow_2` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `openid` (`mini_id`,`openid`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序微信用户表';
...
CREATE TABLE `ky_mini_follow_3` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `openid` (`mini_id`,`openid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序微信用户表';
...
CREATE TABLE `ky_mini_setting` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='小程序配置';
...
CREATE TABLE `ky_mini_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='小程序模板库';
...
CREATE TABLE `ky_mini_template_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  KEY `mini_id_status` (`mini_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='小程序模版记录';
...
CREATE TABLE `ky_mini_tester` (
  ...
  PRIMARY KEY (`id`),
  KEY `mini_id` (`mini_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='小程序体验者';
...
CREATE TABLE `ky_mp_addon` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `mpid_addon` (`mpid`,`addon`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公众号-插件关联表';
...
CREATE TABLE `ky_mp_follow_4` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `openid` (`openid`,`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=1054 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='微信用户表';
...
CREATE TABLE `ky_mp_menu` (
  ...
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'click' COMMENT '类型',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='自定义菜单';
...
CREATE TABLE `ky_mp_msg_1` (
  ...
  PRIMARY KEY (`id`),
  KEY `openid_mpid` (`openid`,`mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='公众号粉丝消息';
...
CREATE TABLE `ky_mp_msg_3` (
  ...
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `openid_mpid` (`openid`,`log_mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `ky_mp_order` (
  ...
  KEY `mpid` (`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='公众号统一订单表';
...
CREATE TABLE `ky_mp_qrcode` (
  ...
  KEY `mpid` (`mpid`),
  KEY `keyword` (`keyword`),
  KEY `ticket` (`ticket`,`mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公众号二维码表';
...
CREATE TABLE `ky_mp_qrcode_log_1` (
  ...
  KEY `qrcode_id_2` (`qrcode_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='公众号二维码被扫记录';
...
CREATE TABLE `ky_mp_rule_1` (
  ...
  PRIMARY KEY (`id`),
  KEY `mpid` (`rule_mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公众号响应规则';
...
CREATE TABLE `ky_mp_rule_2` (
  ...
  PRIMARY KEY (`id`),
  KEY `mpid` (`rule_mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公众号响应规则';
...
CREATE TABLE `ky_mp_rule_3` (
  ...
  PRIMARY KEY (`id`),
  KEY `mpid` (`rule_mpid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公众号响应规则';
...
CREATE TABLE `ky_mp_setting` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='公众号配置';
...
CREATE TABLE `ky_mp_special` (
  ...
  PRIMARY KEY (`id`),
  KEY `mpid` (`spe_mpid`)
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='公众号特殊消息/事件回复';
...
CREATE TABLE `ky_notice` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='系统公告';
...
CREATE TABLE `ky_notice_read` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='已读公告';
...
CREATE TABLE `ky_order_addon` (
  ...
  KEY `user_id` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='应用采购订单';
...
CREATE TABLE `ky_setting` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='站点配置';
