...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='小程序模版记录';

-- ----------------------------
--  Records of `ky_mini_template_log`
-- ----------------------------
BEGIN;
INSERT INTO `ky_mini_template_log` VALUES ('1', '1', '10', '1', 'mini_demo', '{\"ext\":{\"appId\":\"wx85a60c8853fa7d49\"}}', 'v1.0', '第一版', '', null, '0', '', '0', '0', '0', '1595777043', '1595777043');
COMMIT;
