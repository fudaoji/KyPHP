...
CREATE TABLE `ky_mini_template_log` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态，其中0待提交审核 1为审核中， 2为审核成功，3为审核失败，4为已发布, 5:为已撤回',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `ky_mini_template_log` VALUES ('1', '1', '10', '1', 'mini_demo', '{\"ext\":{\"appId\":\"wx85a60c8853fa7d49\"}}', '1.0', '第一版', '', null, '0', '', '0', '0', '0', '1595777043', '1595850926', '0'), ('3', '1', '10', '1', 'mini_demo', '{\"ext\":{\"appId\":\"wx85a60c8853fa7d49\"}}', '2.0', '更新个人中心', 'http://devhhb.images.huihuiba.net/mini_qrcode_test_10_1595863113.png', null, '0', '', '0', '0', '0', '1595850926', '1595863113', '1');
COMMIT;
