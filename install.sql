...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='应用表';
...
-- ----------------------------
BEGIN;
INSERT INTO `ky_addons_info` VALUES ('10', '<p>应用介绍</p><p>adfadf</p><p>到发疯</p><p>阿道夫<img src=\"http://devhhb.images.huihuiba.net/1-5ed603542b0f4.jpg\" alt=\"1-5ed603542b0f4.jpg\"/></p>', '4', '112', '0.01', '0.00', '涨粉,营销,商城', 'http://devhhb.images.huihuiba.net/1-5f1582f10db72.jpg,http://devhhb.images.huihuiba.net/1-5f1582f0b24e6.jpg'), ('11', '<p>详细介绍小程序介绍</p>', '2', '103', '0.00', '398.00', '营销', 'http://devhhb.images.huihuiba.net/1-5f1582f10db72.jpg,http://devhhb.images.huihuiba.net/1-5f1582f0b24e6.jpg');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='小程序应用对应的模板id';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户-应用关联表';

-- ----------------------------
--  Records of `ky_admin_addon`
-- ----------------------------
BEGIN;
INSERT INTO `ky_admin_addon` VALUES ('1', '2', 'demo', '1595692800', '1', '1594814243', '1594816271'), ('3', '1', 'demo', '1689914356', '1', '1594817469', '1595312686'), ('5', '1', 'mini_demo', '1627309992', '1', '1595773992', '1595773992');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='小程序-插件关联表';
