...
/**
 * Created by PhpStorm.
 * Script Name: WxOpenModifyCategorytegory.php
 * Create: 2018/8/30 14:10
 * Description: 修改类目
...
class WxOpenModifyCategory
{
    private $url = "https://api.weixin.qq.com/cgi-bin/wxopen/modifycategory";
    ...
    public function setKey($key) {
        $this->key = $key;
        $this->postParams['certicates']['key'] = $key;
    }
    ...
    public function setValue($value) {
        $this->value= $value;
        $this->postParams['certicates']['value'] = $value;
    }
